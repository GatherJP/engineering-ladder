...
**Actively leverages AI tools such as Claude Code to proactively improve development workflows and increase efficiency.**
...
**Understands startup business milestones and funding context, and approaches development with awareness of how improving customer experience drives business growth.**
...
**Focuses on outcomes rather than rigid adherence to processes; flexibly selects appropriate approaches based on the situation to achieve results.**
...
**Actively learns and adopts new development support tools such as AI tools and code generation technologies into daily development work.**
...
**Examples: resource reuse, tool utilization, automation, leveraging AI tools.**
